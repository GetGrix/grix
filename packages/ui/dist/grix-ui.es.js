...
import se, { createContext as xe, useState as I, useEffect as X, useContext as ye, useCallback as D, useRef as ie } from "react";
var ee = { exports: {} }, V = {};
/**
 * @license React
...
function be() {
  return ce || (ce = 1, process.env.NODE_ENV !== "production" && function() {
    function n(s) {
      ...
      if (typeof s == "object")
        switch (typeof s.tag == "number" && console.error(
          ...
          case z:
            return g = s.displayName || null, g !== null ? g : n(s.type) || "Memo";
          case G:
    ...
    function t(s) {
      ...
      if (g) {
        g = console;
        var w = g.error, A = typeof Symbol == "function" && Symbol.toStringTag && s[Symbol.toStringTag] || s.constructor.name || "Object";
        return w.call(
          g,
    ...
    function E(s, g, w, A, B, N, te, ne) {
      ...
      if (Y.call(g, "key")) {
        ...
        A = 0 < F.length ? "{key: someKey, " + F.join(": ..., ") + ": ...}" : "{key: someKey}", j[M + A] || (F = 0 < F.length ? "{" + F.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (M = null, w !== void 0 && (t(w), M = "" + w), a(g) && (t(g.key), M = "" + g.key), "key" in g) {
        w = {};
        for (var re in g)
          re !== "key" && (w[re] = g[re]);
      } else w = g;
    ...
    var C = se, c = Symbol.for("react.transitional.element"), x = Symbol.for("react.portal"), S = Symbol.for("react.fragment"), d = Symbol.for("react.strict_mode"), v = Symbol.for("react.profiler"), T = Symbol.for("react.consumer"), m = Symbol.for("react.context"), f = Symbol.for("react.forward_ref"), O = Symbol.for("react.suspense"), y = Symbol.for("react.suspense_list"), z = Symbol.for("react.memo"), G = Symbol.for("react.lazy"), k = Symbol.for("react.activity"), q = Symbol.for("react.client.reference"), $ = C.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, Y = Object.prototype.hasOwnProperty, Q = Array.isArray, W = console.createTask ? console.createTask : function() {
      return null;
    };
    C = {
    ...
    var H, K = {}, h = C["react-stack-bottom-frame"].bind(
      C,
      o
    )(), R = W(r(o)), j = {};
    J.Fragment = S, J.jsx = function(s, g, w, A, B) {
...
var le;
function ve() {
  return le || (le = 1, process.env.NODE_ENV === "production" ? ee.exports = me() : ee.exports = be()), ee.exports;
}
var l = ve();
const L = {
  // Vector operations
  ...
  slope(n, e) {
    const t = e.x - n.x, r = e.y - n.y;
    return Math.abs(t) < Number.EPSILON ? t === 0 || t > 0 ? 1 / 0 : -1 / 0 : r / t;
  },
  angle(n, e) {
    const t = e.x - n.x, r = e.y - n.y;
  ...
  boundsIntersect(n, e) {
    return !(n.x + n.width < e.x || e.x + e.width < n.x || n.y + n.height < e.y || e.y + e.height < n.y);
  },
  ...
  worldToScreen(n, e, t) {
    const r = t.width / 2, i = t.height / 2, o = (n.x - e.center.x) * e.zoom, a = (n.y - e.center.y) * e.zoom;
    return {
      x: r + o,
      y: i - a
  ...
  screenToWorld(n, e, t) {
    const r = t.width / 2, i = t.height / 2, o = (n.x - r) / e.zoom, a = (i - n.y) / e.zoom;
    return {
      x: e.center.x + o,
      y: e.center.y + a
    };
  ...
  detectCapabilities() {
    const n = "ontouchstart" in window || navigator.maxTouchPoints > 0, e = n && navigator.maxTouchPoints > 1, t = !0, r = window.matchMedia("(hover: hover)").matches;
    return {
      hasTouch: n,
      hasPencil: e,
      hasKeyboard: t,
  ...
  normalizePointerEvent(n) {
    let e = "mouse";
    return n.pointerType === "touch" ? e = "touch" : n.pointerType === "pen" && (e = "pen"), {
      type: e,
...
const ue = (n) => {
  let e;
  const t = /* @__PURE__ */ new Set(), r = (b, E) => {
    const P = typeof b == "function" ? b(e) : b;
    if (!Object.is(P, e)) {
      const C = e;
      e = E ?? (typeof P != "object" || P === null) ? P : Object.assign({}, e, P), t.forEach((c) => c(e, C));
    }
  }, i = () => e, u = { setState: r, getState: i, getInitialState: () => p, subscribe: (b) => (t.add(b), () => t.delete(b)) }, p = e = n(r, i, u);
  return u;
}, Te = (n) => n ? ue(n) : ue, je = (n) => n;
function we(n, e = je) {
...
const Se = (n) => {
  const e = Te(n), t = (r) => we(e, r);
  return Object.assign(t, e), t;
}, Ee = (n) => Se, Re = (n) => (e, t, r) => {
  const i = r.subscribe;
  return r.subscribe = (a, u, p) => {
    let b = a;
    if (u) {
  ...
  Oe((n, e) => ({
    ...
    selectObject: (t, r = !1) => {
      n((i) => r ? {
        selectedObjects: i.selectedObjects.includes(t) ? i.selectedObjects.filter((a) => a !== t) : [...i.selectedObjects, t]
      } : { selectedObjects: [t] });
    },
    clearSelection: () => {
      n({ selectedObjects: [] });
...
function Me({ children: n }) {
  const [e] = I(() => new Pe()), [t] = I(() => /* @__PURE__ */ new Map()), [r] = I(() => /* @__PURE__ */ new Map()), [i, o] = I(null), [a] = I(() => Ce()), [u] = I(() => Ae()), [p] = I(() => ({
    distance: L.distance,
    slope: L.slope,
    ...
    try {
      ...
      console.error(`Failed to initialize plugin ${c.id}:`, S), t.delete(c.id), r.delete(c.id);
    }
  }, E = (c) => {
    var S;
    const x = t.get(c);
  ...
  X(() => {
    ...
    }, x = c("pointer:down"), S = c("pointer:move"), d = c("pointer:up");
    return e.on("pointer:down", x), e.on("pointer:move", S), e.on("pointer:up", d), () => {
      e.off("pointer:down", x), e.off("pointer:move", S), e.off("pointer:up", d);
    };
  }, [i, t, e]);
  const C = {
    eventBus: e,
...
function _e(n, e, t = {}) {
  const [r, i] = I(null), [o, a] = I(/* @__PURE__ */ new Map()), u = {
    enableGestures: !0,
    touchTargetSize: 44,
    preventScrolling: !0,
    ...t
  ...
  const [p, b] = I({
    ...
    const T = v[0], m = v[1];
    if (!T || !m) return 0;
    const f = T.x - m.x, O = T.y - m.y;
    return Math.sqrt(f * f + O * O);
  }, []), P = D((d) => {
    const v = Array.from(d.values());
    if (v.length === 0) return { x: 0, y: 0 };
    const T = v.reduce((m, f) => ({ x: m.x + f.x, y: m.y + f.y }), { x: 0, y: 0 });
    ...
    a((m) => {
      ...
      return f;
    }), n.current.setPointerCapture(d.pointerId), (T = e.onPointerDown) == null || T.call(e, v);
  }, [n, e, u, E]), c = D((d) => {
    var T;
    const v = U.normalizePointerEvent(d);
    a((m) => {
    ...
    a((m) => {
      ...
      if (f.delete(d.pointerId), u.enableGestures && f.size === 0) {
        const z = d.timeStamp - p.startTime < 200, G = d.timeStamp - p.lastTapTime;
        z && !p.isGesturing && (G < 300 ? b((k) => ({ ...k, tapCount: k.tapCount + 1 })) : ((O = e.onGesture) == null || O.call(e, {
          type: "tap",
          center: { x: v.x, y: v.y },
          touches: 1
        }), b((k) => ({
      ...
      return f;
    }), n.current && n.current.releasePointerCapture(d.pointerId), (T = e.onPointerUp) == null || T.call(e, v);
  }, [n, e, u, p]), S = D((d) => {
    var T;
    const v = U.normalizePointerEvent(d);
    a((m) => {
    ...
    }), b((m) => ({ ...m, isGesturing: !1 })), (T = e.onPointerCancel) == null || T.call(e, v);
  }, [e]);
  return X(() => {
    const d = n.current;
    if (!d) return;
    d.addEventListener("pointerdown", C), d.addEventListener("pointermove", c), d.addEventListener("pointerup", x), d.addEventListener("pointercancel", S);
    const v = (T) => T.preventDefault();
    return d.addEventListener("contextmenu", v), () => {
      d.removeEventListener("pointerdown", C), d.removeEventListener("pointermove", c), d.removeEventListener("pointerup", x), d.removeEventListener("pointercancel", S), d.removeEventListener("contextmenu", v);
    };
  }, [n, C, c, x, S]), {
    capabilities: r,
    activePointers: Array.from(o.values()),
    isGesturing: p.isGesturing,
    touchTargetSize: r ? U.getTouchTargetSize(r.hasTouch ? "touch" : "mouse") : u.touchTargetSize
  };
}
function ze({
  width: n = 800,
  ...
  const S = ie({
    ...
    x.handlePointerDown(h), (h.type === "touch" || h.type === "mouse") && (S.current = {
      isPanning: !0,
    ...
    if (x.handlePointerMove(h), S.current.isPanning) {
      const R = (h.x - S.current.startPoint.x) / o.zoom, j = (h.y - S.current.startPoint.y) / o.zoom;
      a({
        center: {
  ...
  }, [o.zoom, a]), { capabilities: f, touchTargetSize: O } = _e(
    i,
    {
      onPointerDown: d,
      onPointerMove: v,
  ...
  ), y = b === "fine" ? 1 : 10, G = y * o.zoom >= 8, k = {
    left: o.center.x - n / 2 / o.zoom,
    right: o.center.x + n / 2 / o.zoom,
    top: o.center.y + e / 2 / o.zoom,
    bottom: o.center.y - e / 2 / o.zoom
  }, q = Math.floor(k.left / y) * y, $ = Math.ceil(k.right / y) * y, Y = Math.floor(k.bottom / y) * y, Q = Math.ceil(k.top / y) * y, W = [], H = [];
  if (G) {
    for (let h = q; h <= $; h += y) {
      const R = c({ x: h, y: 0 }).x, j = Math.abs(h) < y / 2, s = h % (y * 5) === 0;
      W.push(
        /* @__PURE__ */ l.jsx(
          "line",
          {
    ...
    for (let h = Y; h <= Q; h += y) {
      const R = c({ x: 0, y: h }).y, j = Math.abs(h) < y / 2, s = h % (y * 5) === 0;
      H.push(
        /* @__PURE__ */ l.jsx(
          "line",
          {
  ...
  const K = (h) => {
    switch (h.type) {
      case "ray":
        const R = c(h.properties.startPoint), j = c(h.properties.endPoint);
      ...
      case "rectangle":
        ...
        }), g = h.properties.width * o.zoom, w = h.properties.height * o.zoom;
        return /* @__PURE__ */ l.jsxs("g", { children: [
          /* @__PURE__ */ l.jsx(
            "rect",
            {
  ...
  return /* @__PURE__ */ l.jsxs("div", { className: `relative ${t}`, style: { width: n, height: e }, children: [
    /* @__PURE__ */ l.jsxs(
      "svg",
      {
        ref: i,
        ...
        children: [
          ...
          /* @__PURE__ */ l.jsxs("g", { className: "grid", children: [
            W,
            H
          ] }),
          /* @__PURE__ */ l.jsx("g", { className: "objects", children: u.map(K) }),
          G && /* @__PURE__ */ l.jsxs("g", { className: "labels", fontSize: "12", fill: "#6B7280", children: [
    ...
    f && /* @__PURE__ */ l.jsxs("div", { className: "absolute top-2 left-2 text-xs text-gray-500 bg-white/80 p-2 rounded", children: [
...
function Ne({ className: n = "" }) {
  var o;
  const { activeTool: e, setActiveTool: t } = oe(), r = (a) => {
    t(e === a ? null : a);
  }, i = () => {
    t(null);
  };
  return /* @__PURE__ */ l.jsxs("div", { className: `flex items-center gap-2 p-2 bg-white border-b border-gray-200 ${n}`, children: [
    /* @__PURE__ */ l.jsxs("div", { className: "flex items-center gap-2 mr-4", children: [
      /* @__PURE__ */ l.jsx("div", { className: "text-2xl", children: "🟦" }),
      /* @__PURE__ */ l.jsx("h1", { className: "text-lg font-semibold text-gray-800", children: "Grix" })
    ] }),
    /* @__PURE__ */ l.jsxs("div", { className: "flex items-center gap-1", children: [
      de.map((a) => /* @__PURE__ */ l.jsxs(
        "button",
        {
          onClick: () => r(a.id),
          className: `
          ...
          title: a.description,
          children: [
            /* @__PURE__ */ l.jsx("span", { className: "text-lg", children: a.icon }),
            /* @__PURE__ */ l.jsx("span", { className: "text-sm font-medium", children: a.name })
          ]
        },
        a.id
      )),
      e && /* @__PURE__ */ l.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ l.jsx("span", { className: "text-sm", children: "✕ Clear" })
        }
      )
    ] }),
    /* @__PURE__ */ l.jsx("div", { className: "ml-auto flex items-center gap-4 text-sm text-gray-500", children: e ? /* @__PURE__ */ l.jsxs("span", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ l.jsx("div", { className: "w-2 h-2 bg-green-400 rounded-full" }),
      ((o = de.find((a) => a.id === e)) == null ? void 0 : o.name) || "Active Tool"
    ] }) : /* @__PURE__ */ l.jsxs("span", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ l.jsx("div", { className: "w-2 h-2 bg-gray-300 rounded-full" }),
...
class Ie {
  ...
  init(e) {
    this.context = e, e.events.on("tool:changed", this.handleToolChange.bind(this));
  }
  destroy() {
  ...
  findNearestHandle(e, t = 20) {
    const r = this.context.canvas.screenToWorld(e), i = this.context.canvas.getAllObjects();
    for (const o of i)
      if (o.type === "ray") {
        const a = o;
        this.context.math.distance(r, a.properties.startPoint), this.context.math.distance(r, a.properties.endPoint);
        const u = this.context.canvas.worldToScreen(a.properties.startPoint), p = this.context.canvas.worldToScreen(a.properties.endPoint), b = this.context.math.distance(e, u), E = this.context.math.distance(e, p);
        if (b <= t)
          return { rayId: a.id, handle: "start" };
        if (E <= t)
          return { rayId: a.id, handle: "end" };
      }
    return null;
  }
  onPointerDown(e) {
    const t = { x: e.x, y: e.y }, r = this.snapPoint(this.context.canvas.screenToWorld(t)), i = this.findNearestHandle(t);
    if (i) {
      const o = this.context.canvas.getObject(i.rayId);
      if (o) {
        this.state.currentRay = o, this.state.dragTarget = i.handle, this.state.isCreating = !1;
        return;
      }
    }
  ...
  onPointerMove(e) {
    ...
    const t = { x: e.x, y: e.y }, r = this.snapPoint(this.context.canvas.screenToWorld(t));
    if (this.state.isCreating) {
      const i = this.context.math.slope(this.state.currentRay.properties.startPoint, r), o = r.y - i * r.x;
      this.context.canvas.updateObject(this.state.currentRay.id, {
        properties: {
          ...this.state.currentRay.properties,
          endPoint: r,
          slope: i,
          yIntercept: isFinite(i) ? o : this.state.currentRay.properties.startPoint.y
        }
      });
      ...
      o.slope = a, o.yIntercept = isFinite(a) ? o.startPoint.y - a * o.startPoint.x : o.startPoint.y, this.context.canvas.updateObject(this.state.currentRay.id, {
        properties: o
      });
    }
  ...
  onPointerUp(e) {
    if (this.state.isCreating && this.state.currentRay) {
      const t = { x: e.x, y: e.y }, r = this.snapPoint(this.context.canvas.screenToWorld(t)), i = this.state.currentRay.properties.startPoint;
      this.context.math.distance(i, r) < 0.1 ? this.context.canvas.removeObject(this.state.currentRay.id) : this.context.events.emit("ray:created", {
        rayId: this.state.currentRay.id,
...
class Ge {
  ...
  findRectangleAtPoint(e) {
    ...
    for (const r of t)
      if (r.type === "rectangle") {
        const i = r, { x: o, y: a, width: u, height: p } = i.properties;
        if (e.x >= o && e.x <= o + u && e.y >= a && e.y <= a + p)
          return i;
      }
    return null;
  }
  isNearCorner(e, t, r = 0.5) {
    ...
    return [
      ...
      (b) => this.context.math.distance(e, b) <= r
    );
  }
  onPointerDown(e) {
    const t = { x: e.x, y: e.y }, r = this.snapPoint(this.context.canvas.screenToWorld(t)), i = this.findRectangleAtPoint(r);
    if (i)
      if (this.isNearCorner(r, i)) {
        this.state.currentRectangle = i, this.state.dragTarget = "corner", this.state.isCreating = !1;
        return;
      } else {
        this.state.currentRectangle = i, this.state.dragTarget = "move", this.state.dragOffset = {
  ...
  onPointerMove(e) {
    ...
    if (this.state.isCreating && this.state.startPoint) {
      const i = Math.min(this.state.startPoint.x, r.x), o = Math.min(this.state.startPoint.y, r.y), a = Math.abs(r.x - this.state.startPoint.x), u = Math.abs(r.y - this.state.startPoint.y), p = a * u;
      ...
      const i = r.x - this.state.dragOffset.x, o = r.y - this.state.dragOffset.y;
      this.context.canvas.updateObject(this.state.currentRectangle.id, {
        properties: {
      ...
      if (!i) return;
      const { x: o, y: a, width: u, height: p } = i.properties, b = o + u / 2, E = a + p / 2;
      let P = o, C = a, c = u, x = p;
      r.x > b ? c = r.x - o : (P = r.x, c = o + u - r.x), r.y > E ? x = r.y - a : (C = r.y, x = a + p - r.y), c = Math.max(0.1, c), x = Math.max(0.1, x);
      const S = c * x;
      this.context.canvas.updateObject(this.state.currentRectangle.id, {
        properties: {
          x: P,
...
class $e {
  ...
  updateBadgeElement(e) {
    ...
    if (!t) return;
    const r = e.x + e.width / 2, i = e.y + e.height / 2, o = this.context.canvas.worldToScreen({ x: r, y: i }), a = this.formatArea(e.area, e.width, e.height);
    t.textContent = a;
    const u = t.getBoundingClientRect();
    t.style.left = `${o.x - u.width / 2}px`, t.style.top = `${o.y - u.height / 2}px`;
    const p = this.context.state.getState(), b = 30, E = e.width * p.viewport.zoom, P = e.height * p.viewport.zoom;
    t.style.display = E >= b && P >= b ? "block" : "none";
  }
  formatArea(e, t, r) {
    const i = Math.abs(t - Math.round(t)) < 1e-3, o = Math.abs(r - Math.round(r)) < 1e-3;
    if (i && o) {
      const a = Math.round(t), u = Math.round(r);
      return `${a} × ${u} = ${a * u}`;
    }
...
function We() {
  const { registerPlugin: n } = oe(), e = ie(!1);
  return X(() => {
    if (e.current) return;
    const t = De(), r = Be(), i = Ye();
    return n(t), n(r), n(i), e.current = !0, () => {
    };
  }, [n]), /* @__PURE__ */ l.jsxs("div", { className: "flex flex-col h-screen bg-gray-50", children: [
    /* @__PURE__ */ l.jsx(Ne, {}),
    /* @__PURE__ */ l.jsx("div", { className: "flex-1 relative", "data-grix-canvas": !0, children: /* @__PURE__ */ l.jsx(
      ze,
      {
